...
namespace BotVinculacionUnitec
{
    ...
    {
        SqlConnection myConnection = new SqlConnection("Server=tcp:hours-tracker.database.windows.net,1433;Initial Catalog=HoursTracker;Persist Security Info=False;User ID=HoursTracker;Password=H0ur5-7r4ck3r-123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        ...
        public bool AccountVerified(string accountNumber)
        {
            ...
            OpenConnection();
            selectCommand.Parameters.AddWithValue("@NumeroCuenta", accountNumber);
        ...
        {
            SqlConnection Connection = new SqlConnection("Server=tcp:hours-tracker.database.windows.net,1433;Initial Catalog=HoursTracker;Persist Security Info=False;User ID=HoursTracker;Password=H0ur5-7r4ck3r-123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
